...
class ExpressServer {
    ...
    setupMiddleware() {
      ...
      this.app.get('/', (req, res) => res.sendFile(path.join(__dirname,'html','homePage.html')));
			...
			this.app.get('/ShowOneElement', (req, res) => res.sendFile(path.join(__dirname,'html','ShowOneElement.html')));
			this.app.get('/ShowOneElement/:id', (req, res) => res.sendFile(path.join(__dirname,'html','ShowOneElement.html')));
